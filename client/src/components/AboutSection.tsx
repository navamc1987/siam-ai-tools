        ...
        <div ref={ref} className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-white/70 text-base leading-relaxed mb-4">
              เราเป็นผู้เชี่ยวชาญด้านการต่อเติม รีโนเวท และวิศวกรรมไฟฟ้า ให้บริการครบวงจรตั้งแต่การออกแบบ
              ติดตั้ง ไปจนถึงการซ่อมบำรุงระบบไฟฟ้าในอาคารและโรงงานอุตสาหกรรม
            </p>
